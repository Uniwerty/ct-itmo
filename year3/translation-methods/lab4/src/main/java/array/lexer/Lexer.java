...
public class Lexer {
    ...
    public Lexer(String string) {
        ...
        tokenMatchers.add(Pattern.compile("Tuple").matcher(string));
        tokenMatchers.add(Pattern.compile("Array").matcher(string));
        tokenMatchers.add(Pattern.compile("\\w+").matcher(string));
        tokenMatchers.add(Pattern.compile("\\?").matcher(string));
        tokenMatchers.add(Pattern.compile("\\$").matcher(string));
        tokenMatchers.add(Pattern.compile("var").matcher(string));
        tokenMatchers.add(Pattern.compile("<").matcher(string));
        tokenMatchers.add(Pattern.compile(",").matcher(string));
        tokenMatchers.add(Pattern.compile(">").matcher(string));
        tokenMatchers.add(Pattern.compile(":").matcher(string));
